  ...
  [9160],
  {
    ...
    7400: function (n, i, t) {
      ...
      var d = (0, r.P1)([l], function (n) {
        ...
        B = (0, r.P1)([l], function (n) {
          return n.hotspotSelected || void 0;
        }),
        O = (0, r.P1)([f, F, M], function (n, i, t) {
          var o, r, u;
          return (
            null == n
              ? void 0
      ...
      var V = (0, r.P1)([l], function (n) {
        ...
        no = (0, r.P1)([F, Y], function (n, i) {
          return (0, c.fq)(n, i);
        }),
        nr = (0, r.P1)([F, Y], function (n, i) {
          return (0, c.$y)(n, i);
        }),
          ...
          T = (0, d.useMemo)(
            function () {
              ...
              return (
                (null == p ? void 0 : p.src) &&
                  n.push({
                    url: null == p ? void 0 : p.src,
                    width: 800,
                    height: 600,
                    alt: null == p ? void 0 : p.name,
                  }),
                C && n.push({ url: C, width: 800, height: 600, alt: "" }),
                (null == y ? void 0 : y.src) &&
                  n.push({
                    url:
                      (null == y ? void 0 : y.src_thumb) ||
                      (null == y ? void 0 : y.src_preview) ||
                      (null == y ? void 0 : y.src),
                    width: 800,
                    height: 600,
        ...
        return (
          (0, d.useEffect)(function () {
            if (!P.sk) {
              var n = window;
              n.offline_id &&
                i((0, f.b6)({ id: n.offline_id, isPublic: !0, isPayment: !0 }));
            }
          }, []),
          (0, d.useEffect)(
            function () {
              if (c && c.length) {
                var t = Object.fromEntries(
                  ...
                  u = Z ? (0, o.Z)({}, Z) : (0, o.Z)({}, c[0]);
                n.query.scene &&
                  (u =
                    (0, o.Z)(
                      {},
                      c.filter(function (i) {
                        return i.id === n.query.scene;
                      })[0]
                    ) || (0, o.Z)({}, c[0])),
                  t.scene &&
                    (u =
                  ...
                  (u.config =
                    (0, o.Z)({}, null == u ? void 0 : u.config) || {}),
                  (u.config = (0, r.Z)((0, o.Z)({}, u.config), {
                    isLittlePlanet: (null == b ? void 0 : b.enable) || !1,
                    timeTransitionLittlePlanet:
                      (null == b ? void 0 : b.transition_time) || 2,
                  })),
                  i(f.Nw.setSceneSelected(u));
              }
            },
            [c.length]
          ),
          (0, e.jsxs)(e.Fragment, {
            children: [
              (0, e.jsx)(v.PB, {
                title: (null == l ? void 0 : l.title) || t,
                description:
                  (null == l ? void 0 : l.description) ||
                  "Panoee - Virtual Tour 360",
                additionalLinkTags: (null == l ? void 0 : l.favicon)
                  ? (0, u.Z)([
                      {
                        rel: "shortcut icon",
                        href: null == l ? void 0 : l.favicon,
                      },
                    ]).concat((0, u.Z)(m.hj))
                  : (0, u.Z)(m.XB).concat((0, u.Z)(m.hj)),
                openGraph: {
                  type: "website",
                  url: "https://tour.panoee.com" + n.asPath,
                  title: (null == l ? void 0 : l.title) || t,
                  description:
                    (null == l ? void 0 : l.description) ||
                    "Panoee - Virtual Tour 360",
                  images: T,
                  site_name:
                    (null == l ? void 0 : l.title) || t || "Panoee Tour",
                  profile: { username: n.query.username },
                },
...
//# sourceMappingURL=export-frontend-4d00b7aa09cb7402.js.map
