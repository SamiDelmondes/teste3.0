    ...
    7400: function (n, t, i) {
      ...
      var d = (0, r.P1)([l], function (n) {
        ...
        w = (0, r.P1)([f], function (n) {
          var t, i;
          return (0,
          o.Z)({}, u.TR, null == n ? void 0 : null === (t = n.config) || void 0 === t ? void 0 : null === (i = t.design) || void 0 === i ? void 0 : i.formCaptureConfig);
        }),
        _ = (0, r.P1)([f], function (n) {
          var t, i;
          return (0,
          o.Z)({}, u.AN, null == n ? void 0 : null === (t = n.config) || void 0 === t ? void 0 : null === (i = t.design) || void 0 === i ? void 0 : i.callToActionConfig);
        }),
        ...
        M = (0, r.P1)([I], function (n) {
          return n
            .reduce(function (n, t) {
              return n.push(t.scenes), n;
            }, [])
            .flat();
        }),
      ...
      var V = (0, r.P1)([l], function (n) {
        ...
        K = (0, r.P1)([X, $], function (n, t) {
          return (
            (t &&
              t.form &&
              n.filter(function (n) {
                return n.id === (null == t ? void 0 : t.form);
              })[0]) ||
            void 0
          );
        }),
        ...
        no = (0, r.P1)([F, Y], function (n, t) {
          return (0, c.fq)(n, t);
        }),
        nr = (0, r.P1)([F, Y], function (n, t) {
          return (0, c.$y)(n, t);
        }),
        ...
        ns = (0, r.P1)([f, na], function (n, t) {
          return (null == n ? void 0 : n.user) === (null == t ? void 0 : t.id);
        }),
        ng = (0, r.P1)([l], function (n) {
          return n.isAllowToAccessOnCollaborationMode;
        });
    },
    90259: function (n, t, i) {
      "use strict";
      i.r(t),
        i.d(t, {
          __N_SSG: function () {
      ...
      var o = i(47568),
        ...
        y = a()(
          function () {
            return Promise.all([i.e(4974), i.e(9636)]).then(i.bind(i, 44974));
          },
          {
            loadableGenerated: {
              webpack: function () {
            ...
            loading: function () {
              return (0, d.jsx)("span", { children: "Loading" });
            },
          }
        ),
        b = !0;
      t.default = function () {
          ...
          x = (0, v.useMemo)(
            function () {
              ...
              return (
                (null == m ? void 0 : m.src) &&
                  n.push({
                    url: null == m ? void 0 : m.src,
                    width: 800,
                    height: 600,
                    alt: null == m ? void 0 : m.name,
                  }),
                j && n.push({ url: j, width: 800, height: 600, alt: "" }),
                (null == T ? void 0 : T.src) &&
                  n.push({
                    url:
                      (null == T ? void 0 : T.src_thumb) ||
                      (null == T ? void 0 : T.src_preview) ||
                      (null == T ? void 0 : T.src),
                    width: 800,
                    height: 600,
                ...
                switch (o.label) {
                  ...
                  case 2:
                    return (
                      (n = o.sent()),
                      t(s.b6.success(n)),
                      [4, fetch("".concat("", "/post.json"))]
                    );
                  case 4:
                    return (
                      (i = o.sent()),
                      t(s.Nw.setListPostUsedOnTour(i)),
                      A(!0),
                      [3, 7]
                    );
                  case 5:
        ...
        return (
            ...
            function () {
              if (f && f.length) {
                var i = Object.fromEntries(
                  ...
                  o = L ? (0, r.Z)({}, L) : (0, r.Z)({}, f[0]);
                n.query.scene &&
                  (o =
                    (0, r.Z)(
                      {},
                      f.filter(function (t) {
                        return t.id === n.query.scene;
                      })[0]
                    ) || (0, r.Z)({}, f[0])),
                  i.scene &&
                    (o =
                  ...
                  (o.config =
                    (0, r.Z)({}, null == o ? void 0 : o.config) || {}),
                  (o.config = (0, u.Z)((0, r.Z)({}, o.config), {
                    isLittlePlanet: (null == k ? void 0 : k.enable) || !1,
                    timeTransitionLittlePlanet:
                      (null == k ? void 0 : k.transition_time) || 2,
                  })),
                  t(s.Nw.setSceneSelected(o));
              }
            },
            [f.length]
          ),
          (0, d.jsxs)(d.Fragment, {
            children: [
              (0, d.jsx)(g.PB, {
                title: (null == a ? void 0 : a.title) || i,
                description:
                  (null == a ? void 0 : a.description) ||
                  "Panoee - Virtual Tour 360",
                additionalLinkTags: (null == a ? void 0 : a.favicon)
                  ? (0, c.Z)([
                      {
                        rel: "shortcut icon",
                        href: null == a ? void 0 : a.favicon,
                      },
                    ]).concat((0, c.Z)(_.hj))
                  : (0, c.Z)(_.XB).concat((0, c.Z)(_.hj)),
                openGraph: {
                  type: "website",
                  ...
                  images: x,
                  site_name:
                    (null == a ? void 0 : a.title) || i || "Panoee Tour",
...
//# sourceMappingURL=export-full-bb75f289b11ea3e1.js.map
